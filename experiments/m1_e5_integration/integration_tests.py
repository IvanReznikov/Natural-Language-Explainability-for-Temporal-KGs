...
class IntegrationTestSuite:
    ...
    def test_template_llm_integration(self):
        ...
        try:
            fact = TemporalFact(
                fact_type=TemplateType.POINT_IN_TIME, event="birth", entity="Test", date="2000"
            )
            renderer = TemplateRenderer()
            output = renderer.render(fact)
            self.test("Template renders basic fact", len(output) > 0, f"Output: {output}")
    ...
    def test_hybrid_system_integration(self):
        ...
        try:
            ...
            self.test("Hybrid generator initializes", generator is not None, "")
        except Exception as e:
        ...
        try:
            fact = TemporalFact(
                fact_type=TemplateType.POINT_IN_TIME, event="test", entity="Entity", date="2000"
            )
        ...
        try:
            ...
            fact = TemporalFact(
                fact_type=TemplateType.POINT_IN_TIME, event="test", entity="Cache Test", date="2000"
            )
    ...
    def test_hybrid_llm_fallback(self):
        ...
        try:
            generator = HybridGenerator()
            fact = TemporalFact(
                fact_type=TemplateType.POINT_IN_TIME, event="demo", entity="Fallback", date="2020"
            )
    ...
    def test_evaluation_integration(self):
        ...
        try:
            ...
            self.test("Accuracy evaluator initializes", evaluator is not None, "")
        except Exception as e:
        ...
        try:
            fact = TemporalFact(
                fact_type=TemplateType.POINT_IN_TIME, event="birth", entity="Einstein", date="1879"
            )
    ...
    def test_error_handling(self):
        ...
        try:
            renderer = TemplateRenderer()
            invalid_fact = TemporalFact(fact_type="INVALID", event="test")
            try:
        ...
        try:
            ...
            self.test("Handles empty batch", len(results) == 0, "")
        except Exception as e:
    ...
    def test_performance(self):
        ...
        try:
            ...
            self.test(
                "Template p50 latency <20ms", avg_latency_ms < 20, f"Avg: {avg_latency_ms:.2f}ms"
            )
        except Exception as e:
        ...
        try:
            ...
            self.test("Cached access <2ms", avg_cached_ms < 2, f"Avg: {avg_cached_ms:.3f}ms")
        except Exception as e:
