...
class M1Comparator:
    ...
    def compare(self) -> str:
        ...
        for metric_name, key, formatter in metrics:
            ...
            if key == "latency_ms":
                winner = "E1" if e1_val == min(e1_val, e2_val, e3_val) else ("E2" if e2_val < e3_val else "E3")
            else:
                winner = "E1" if e1_val == max(e1_val, e2_val, e3_val) else ("E2" if e2_val > e3_val else "E3")
