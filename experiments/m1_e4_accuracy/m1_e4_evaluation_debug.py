...
def analyze_results(results_dir: str):
    ...
    checks = {
        ...
        "Template > Polished": metrics.get('template_accuracy', 0) > metrics.get('polished_accuracy', 0),
    }
    ...
    if csv_path.exists():
        ...
        print("-"*100)
        print(f"{'Type':<15} {'Source':<10} {'Overall':<10} {'Date':<8} {'Entity':<8} {'Relation':<10}")
        print("-"*100)
        for r in results_sorted[:10]:
            ...
            print(f"{typ:<15} {source:<10} {overall:<10.4f} {date:<8.4f} {entity:<8.4f} {relation:<10.4f}")
