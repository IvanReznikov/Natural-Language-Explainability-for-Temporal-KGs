...
class AccuracyScorer:
    ...
    def score_entity_preservation(self, fact_entities: Dict[str, List[str]], 
                                  output_entities: Dict[str, List[str]]) -> float:
        """
    ...
    def score_relation_preservation(self, fact: Any, 
                                    output_entities: Dict[str, List[str]]) -> float:
        """
