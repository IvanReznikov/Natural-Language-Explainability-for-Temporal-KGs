...
class HallucinationDetector:
    ...
    def detect(self, fact: Any, output: str, 
               output_entities: Dict[str, List[str]]) -> Tuple[bool, str]:
        """
        ...
        try:
            ...
            if self._has_temporal_relations(str(fact_content)) and not self._has_temporal_relations(output_str):
    ...
    def _has_temporal_relations(self, text: str) -> bool:
        ...
        temporal_keywords = [
            'century', 'decade', 'year', 'period', 'era', 'age',
            'before', 'after', 'during', 'while', 'when',
            'caused', 'led to', 'resulted in',
            'lasting', 'lasted', 'spanned', 'extended',
        ]
