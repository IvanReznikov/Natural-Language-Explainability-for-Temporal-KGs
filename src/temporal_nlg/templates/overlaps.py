...
OVERLAP_TEMPLATES = [
    ...
    {
        "id": "ov_micro_1",
        "template": "{events_joined} together.",
        "clarity_score": 4.9,
        "readability_score": 94.0,
    },
    {
        "id": "ov_micro_2",
        "template": "Both: {events_joined}.",
        "clarity_score": 4.8,
        "readability_score": 92.5,
    },
    {
        "id": "ov_micro_3",
        "template": "Same time: {events_joined}.",
        "clarity_score": 4.8,
        "readability_score": 92.0,
    },
    {
        "id": "ov_bare_1",
        "template": "{events_joined} at same time.",
        "clarity_score": 4.9,
        "readability_score": 92.3,
    },
    {
        "id": "ov_bare_2",
        "template": "{events_joined} both true.",
        "clarity_score": 4.9,
        "readability_score": 91.8,
    },
    {
        "id": "ov_bare_3",
        "template": "{events_joined} as one.",
        "clarity_score": 4.8,
        "readability_score": 90.5,
    },
    {
        "id": "ov_both_1",
        "template": "{first_event} and {other_events_joined} both.",
        "clarity_score": 4.8,
        "readability_score": 89.2,
    },
    {
        "id": "ov_same_1",
        "template": "All {event_count} at once: {events_joined}.",
        "clarity_score": 4.7,
    ...
    {
        "id": "ov_time_1",
        "template": "In {time_period}: {events_joined}.",
        "clarity_score": 4.7,
        "readability_score": 83.2,
    },
    {
        "id": "ov_when_1",
        "template": "When {time_period}, {events_joined}.",
        "clarity_score": 4.7,
        "readability_score": 81.9,
    },
    {
        "id": "ov_during_1",
        "template": "In {time_period}, {events_joined} were on.",
        "clarity_score": 4.6,
        "readability_score": 79.4,
    },
    {
        "id": "ov_list_1",
        "template": "{events_joined} - all {time_period}.",
        "clarity_score": 4.6,
        "readability_score": 80.5,
    },
    {
        "id": "ov_span_1",
        "template": "{events_joined} in {time_period}.",
        "clarity_score": 4.7,
        "readability_score": 82.8,
    },
    # While/Parallel (11-15)
    {
        "id": "ov_while_1",
        "template": "While {first_event}, {other_events_joined} too.",
        "clarity_score": 4.6,
        "readability_score": 78.1,
    },
    {
        "id": "ov_with_1",
        "template": "{first_event} with {other_events_joined}.",
        "clarity_score": 4.7,
        "readability_score": 84.6,
    },
    {
        "id": "ov_par_1",
        "template": "{events_joined} side by side.",
        "clarity_score": 4.7,
        "readability_score": 83.3,
    },
    {
        "id": "ov_all_1",
        "template": "All: {events_joined}.",
        "clarity_score": 4.8,
        "readability_score": 88.2,
    },
    {
        "id": "ov_go_1",
        "template": "{events_joined} go as one.",
        "clarity_score": 4.6,
        "readability_score": 81.7,
    },
    # Simple join (16-20)
    {
        "id": "ov_join_1",
        "template": "{events_joined} all at once.",
        "clarity_score": 4.7,
        "readability_score": 82.4,
    },
    {
        "id": "ov_now_1",
        "template": "Now: {events_joined}.",
        "clarity_score": 4.8,
        "readability_score": 86.1,
    },
    {
        "id": "ov_here_1",
        "template": "Here: {events_joined}.",
        "clarity_score": 4.7,
        "readability_score": 84.9,
    },
    {
        "id": "ov_this_1",
        "template": "This: {events_joined}.",
        "clarity_score": 4.7,
        "readability_score": 85.3,
    },
    {
        "id": "ov_take_1",
        "template": "Take {event_count}: {events_joined}.",
        "clarity_score": 4.6,
        "readability_score": 81.2,
    },
]
