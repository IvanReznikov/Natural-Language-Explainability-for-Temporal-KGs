...
class PointInTimeExampleGenerator:
    ...
    POINT_IN_TIME_DATASET = [
        ...
        },
        {
            ...
            "event": "published Special Relativity",
            "date": "June 30, 1905",
            "location": "Bern, Switzerland",
            "description": "annus mirabilis breakthrough",
        },
        {
            ...
            "description": "founding of nation",
        },
        {
            "entity": "Neil Armstrong",
            "event": "walked on the Moon",
            "date": "July 20, 1969",
            "location": "Sea of Tranquility",
            "description": "Apollo 11 milestone",
        },
        {
            "entity": "Chernobyl Nuclear Power Plant",
            "event": "experienced nuclear disaster",
            "date": "April 26, 1986",
            "location": "Soviet Union",
            "description": "worst nuclear accident",
        },
        {
            ...
            "description": "Tim Berners-Lee creation",
        },
        {
            "entity": "Berlin Wall",
            "event": "fell, ending Cold War",
            "date": "November 9, 1989",
            "location": "Berlin, Germany",
            "description": "geopolitical turning point",
        },
        {
            "entity": "WHO",
            "event": "declared COVID-19 pandemic",
            "date": "March 11, 2020",
        ...
        },
        {
            ...
            "event": "discovered Mandelbrot set",
            "date": "November 1, 1980",
            "location": "IBM Research",
            "description": "fractal geometry breakthrough",
        },
        {
            "entity": "Jane Goodall",
            "event": "began chimpanzee study",
            "date": "July 1960",
            "location": "Gombe Stream, Tanzania",
            "description": "primatology research",
        },
        # Science & Technology (20 more - optimized)
        {
            "entity": "Isaac Newton",
            "event": "formulated gravity law",
            "date": "1687",
            "location": "Cambridge",
        ...
        },
        {
            ...
            "event": "published evolution theory",
        ...
        },
        {
            ...
            "event": "tested light bulb",
            "date": "October 21, 1879",
            "location": "Menlo Park",
            "description": "electric lighting",
        },
        {
            "entity": "Nikola Tesla",
            "event": "transmitted wireless electricity",
            "date": "1891",
        ...
        },
        {
            ...
            "event": "captured Photo 51",
            "date": "May 2, 1952",
            "location": "King's College London",
            "description": "DNA structure evidence",
        },
        {
            "entity": "Jonas Salk",
            "event": "announced polio vaccine",
            "date": "April 12, 1955",
            "location": "Ann Arbor",
        ...
        },
        {
            ...
            "event": "proposed Hawking radiation",
            "date": "1974",
            "location": "Cambridge",
            "description": "black hole physics",
        },
        {
            "entity": "Jennifer Doudna and Emmanuelle Charpentier",
            "event": "developed CRISPR",
            "date": "2012",
        ...
        # Politics & Government (20 more - optimized)
        {
            ...
            "event": "crowned himself Emperor",
            "date": "December 2, 1804",
            "location": "Notre-Dame, Paris",
            "description": "French power consolidation",
        },
        {
            "entity": "Abraham Lincoln",
            "event": "issued Emancipation Proclamation",
            "date": "January 1, 1863",
            "location": "Washington, D.C.",
            "description": "freed enslaved people",
        },
        {
            "entity": "Mahatma Gandhi",
            "event": "led India to independence",
            "date": "August 15, 1947",
            "location": "New Delhi",
        ...
        },
        {
            ...
            "event": "became South Africa President",
            "date": "May 10, 1994",
            "location": "Johannesburg",
            "description": "end of apartheid",
        },
        {
            "entity": "Rosa Parks",
            "event": "refused to give up bus seat",
            "date": "December 1, 1955",
            "location": "Montgomery, Alabama",
            "description": "Civil Rights spark",
        },
        {
            "entity": "Martin Luther King Jr.",
            "event": "delivered 'I Have a Dream' speech",
            "date": "August 28, 1963",
            "location": "Washington, D.C.",
        ...
        },
        {
            ...
            "event": "introduced glasnost and perestroika",
            "date": "1985",
            "location": "Soviet Union",
            "description": "Cold War transformation",
        },
        {
            "entity": "Margaret Thatcher",
            "event": "became UK Prime Minister",
            "date": "May 3, 1979",
            "location": "London",
            "description": "first female PM",
        },
        {
            "entity": "Barack Obama",
            "event": "became US President",
        ...
        # Culture & Arts (15 more - optimized)
        {
            ...
            "event": "completed Guernica",
            "date": "June 1937",
            "location": "Paris",
            "description": "anti-war masterpiece",
        },
        {
            "entity": "The Beatles",
            "event": "released Sgt. Pepper's album",
            "date": "June 1, 1967",
            "location": "London",
        ...
        {
            "entity": "Hollywood",
            "event": "held first Academy Awards",
            "date": "May 16, 1929",
            "location": "Los Angeles",
            "description": "cinema awards",
        },
        {
            ...
            "date": "April 2, 1968",
            "location": "London",
            "description": "sci-fi cinema",
        },
        {
            "entity": "Stephen King",
            "event": "published The Shining",
            "date": "1977",
            "location": "United States",
            "description": "horror literature",
        },
        {
            "entity": "David Bowie",
            "event": "released Ziggy Stardust",
            "date": "June 16, 1972",
            "location": "London",
            "description": "glam rock album",
        },
        {
            "entity": "Internet Archive",
            "event": "began digital preservation",
            "date": "1996",
            "location": "San Francisco",
            "description": "web preservation",
        },
        # Sports (10 more - optimized)
        {
            "entity": "Muhammad Ali",
            "event": "won heavyweight boxing title",
            "date": "February 25, 1964",
            "location": "Miami Beach",
            "description": "sports milestone",
        },
        {
            "entity": "Pelé",
            "event": "scored 1000th goal",
            "date": "November 19, 1969",
            "location": "Rio de Janeiro",
            "description": "football milestone",
        },
    ]
...
class IntervalExampleGenerator:
    ...
    INTERVAL_DATASET = [
        ...
        {
            "entity": "Jazz Age",
            "event": "dominated music",
            "start_date": "1920",
            "end_date": "1929",
            "duration": "9 years",
        },
        {
            "entity": "Harlem Renaissance",
            "event": "flourished",
            "start_date": "1920",
            "end_date": "1930",
            "duration": "10 years",
        },
        {
            "entity": "Modernism",
            "event": "evolved",
            "start_date": "late 1800s",
            "end_date": "mid-1900s",
            "duration": "50 years",
        },
        {
            "entity": "Counterculture",
