...
INTENT_URL = (
    "https://storage.googleapis.com/explanability-for-temporal-graphs/intent/model.safetensors"
)
PARSER_URL = (
    "https://storage.googleapis.com/explanability-for-temporal-graphs/parser/model.safetensors"
)
