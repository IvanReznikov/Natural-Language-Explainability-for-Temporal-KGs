...
CONFIGS = [
    ...
    ("f569b1f7239c4066a29cc4471ef0167a",
     dict(word_ngram_range=(1,2), max_features_word=8000, include_char=False,
          char_ngram_range=(3,5), max_features_char=12000,
          calibration="none", calibration_cv=3, class_weight_mode="balanced",
    ...
    ("1817849eef854d78a71a766e70570c45",
     dict(word_ngram_range=(1,2), max_features_word=8000, include_char=True,
          char_ngram_range=(3,5), max_features_char=12000,
          calibration="none", calibration_cv=3, class_weight_mode="balanced",
          pos_class_weight=1.0),
     0.45, [42], {"exp_id":"T6"}),
    ...
    ("b5b155311494432498e99edf56291f04",
     dict(word_ngram_range=(1,2), max_features_word=8000, include_char=True,
          char_ngram_range=(4,6), max_features_char=12000,
          calibration="none", calibration_cv=3, class_weight_mode="balanced",
          pos_class_weight=1.0),
     0.45, [42], {"exp_id":"T7"}),
    ...
    ("f7dcd7b5ffbc4afa8bcdb660b3d36c08",
     dict(word_ngram_range=(1,2), max_features_word=8000, include_char=True,
          char_ngram_range=(3,5), max_features_char=20000,
          calibration="none", calibration_cv=3, class_weight_mode="balanced",
          pos_class_weight=1.0),
     0.45, [42], {"exp_id":"T8"}),
    ...
    ("f1c4283e4f4f4a7e80ae433787ce7da0",
     dict(word_ngram_range=(1,2), max_features_word=8000, include_char=True,
          char_ngram_range=(4,6), max_features_char=20000,
          calibration="none", calibration_cv=3, class_weight_mode="balanced",
          pos_class_weight=1.0),
     0.45, [42], {"exp_id":"T9"}),
    ...
    ("3b61fbfe8d064f03a042257e1c1dd999",
     dict(word_ngram_range=(1,2), max_features_word=8000, include_char=True,
          ...
          calibration="none", calibration_cv=3, class_weight_mode="balanced",
          pos_class_weight=1.0),
     "per_label", [42], {"exp_id":"T11"}),
    # T12 — Platt calibration
    ("501dd8a1a10e4fb58c682a59ef5b330e",
     dict(word_ngram_range=(1,2), max_features_word=8000, include_char=True,
          char_ngram_range=(3,5), max_features_char=20000,
          calibration="platt", calibration_cv=3, class_weight_mode="balanced",
          pos_class_weight=1.0),
     0.45, [42], {"exp_id":"T12"}),
    ...
    ("4f66cd86f2c74ded9012904945cfacca",
     dict(word_ngram_range=(1,2), max_features_word=8000, include_char=True,
          char_ngram_range=(3,5), max_features_char=20000,
          calibration="isotonic", calibration_cv=3, class_weight_mode="balanced",
          pos_class_weight=1.0),
     0.45, [42], {"exp_id":"T13"}),
    ...
    ("a429b78732164d6c8ea010e48f547faa",
     dict(word_ngram_range=(1,2), max_features_word=8000, include_char=True,
          char_ngram_range=(3,5), max_features_char=20000,
          calibration="isotonic", calibration_cv=3, class_weight_mode="pos-mult",
...
def run_single(run_id, cfg, threshold_mode, seeds, extra_meta, train, val, test):
    def _train_one(seed):
        return train_classifier(
            train, val, INTENT_TAXONOMY, 0.5,
            False, GRID_VALS,
            cfg["calibration"], cfg["calibration_cv"],
            cfg["class_weight_mode"], cfg["pos_class_weight"],
            cfg["word_ngram_range"], cfg["max_features_word"],
            cfg["include_char"], cfg["char_ngram_range"], cfg["max_features_char"],
            seed,
        )
    ...
    if len(seeds) == 1:
        ...
        combined = {"validation": val_metrics, "test": test_metrics,
                    "label_thresholds": label_thresholds.tolist(), "seeds": seeds,
                    **extra_meta}
    else:
